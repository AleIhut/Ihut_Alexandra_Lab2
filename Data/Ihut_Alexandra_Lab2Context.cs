...
namespace Ihut_Alexandra_Lab2.Data
{
    public class Ihut_Alexandra_Lab2Context : DbContext
    {
        ...
        public DbSet<Ihut_Alexandra_Lab2.Models.Author> Author { get; set; }

        public DbSet<Ihut_Alexandra_Lab2.Models.Category> Category { get; set; }

        public DbSet<Ihut_Alexandra_Lab2.Models.Member> Member { get; set; }

        public DbSet<Ihut_Alexandra_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
